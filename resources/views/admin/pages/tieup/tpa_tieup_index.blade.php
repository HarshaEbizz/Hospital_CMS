                ...
                <div class="accordion-body">
                    <div class="container-fluid doctors_profile">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{route('admin.tieup.store')}}" method="POST" id="tpa_page_contain_form" name="tpa_page_contain_form" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-lg-12">
                                                <input type="hidden" class="form-control" id="contain_for" name="contain_for" value="tpa" />
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">Title</label>
                                                    <input type="text" class="form-control" id="title" name="title" value="@if($tpa_contain){{$tpa_contain->title}} @endif" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    <label for="note" class="form-label">Note</label>
                                                    <input type="text" class="form-control" id="note" name="note" value="@if($tpa_contain){{$tpa_contain->note}} @endif" />
                                                </div>
                                            </div>
                                            <div>
                                                <button class="btn btn_green" type="submit" id="tpa_btn">
                                                    @if($tpa_contain) Update @else Add @endif
                                                </button>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive big tableinsidetable">
                                        <table class="display tpa_tieup_list" id="tpa_basic_1">
                                            {{-- <button class="btn right_pop_btn" type="button" data-bs-toggle="modal" data-bs-target="#add_vision_mission_model" data-whatever="@mdo"> --}}
                                            <button class="btn right_pop_btn add_data" type="button" data-id="tpa">
                                                Add Tie-Up
                                            </button>
                                            <thead>
                                                <tr>
