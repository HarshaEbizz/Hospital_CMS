...
<div class="page-body">
    ...
    <div class="container-fluid doctors_profile">
        <div class="card">
            <div class="card-body">
                <form class="" method="POST" action="{{route('admin.terms_and_condition.update',$term->id)}}" id="edit_terms_and_condition_form" name="edit_terms_and_condition_form">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sub_title" name="sub_title" value="{{ $term->sub_title }}" />
                                @if ($errors->has('title'))
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Message " id="description" name="description">{!!  $term->description !!}</textarea>
                                </div>
