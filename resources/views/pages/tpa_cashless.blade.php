...
@section('content')
<!-- first section -->
<section class="page_heading_floor cashless_section">
    <div class="container">
        <h1 class="cashless_title">
        ...
        <nav style="--bs-breadcrumb-divider: '>>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">TPA & Cashless Tie Ups</li>
            </ol>
            <p>
            </p>
...
<section class="inter_patient_content padding_tb_100">
    <div class="container">
        ...
        <div class="row pt-sm-5 pt-3">
            @foreach ($tpa_tieups as $tpa_tieup)
            @php
            $image = str_replace('/public', '', url('/')) . '/storage/' . $tpa_tieup->image_path . $tpa_tieup->company_logo;
            @endphp
            <div class="col-lg-3">
                <div class="text-center empanel_info mb-4">
                    <img src="{{ $image }}" alt="" class="w-100">
                    <div class="overlay">
                        <span>{{$tpa_tieup->company_name}}</span>
                    </div>
                </div>
            </div>
            @endforeach
