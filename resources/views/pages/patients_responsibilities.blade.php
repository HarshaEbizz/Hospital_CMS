...
if($rights_responsibilities->cover_image==null)
{
$image = asset('assets/images/patient_respons.png');
}
}@endphp
<section class="page_heading responibilities_section" style='background:url("{{ $image }}")'>
    <div class="container">
        <h1 class="responibilities_title" style="text-transform: capitalize;">
            {{ucfirst($rights_responsibilities->heading)}}
        </h1>
        <nav style="--bs-breadcrumb-divider: '>>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page" style="text-transform: capitalize;">{{ucfirst($rights_responsibilities->heading)}}</li>
            </ol>
            <p>
            </p>
                ...
                <div class="tab-pane fade show active" id="ambulance" role="tabpanel" aria-labelledby="ambulance-tab">
                    <div class="amenities_box mb-5">
                        <div class="row p-md-5 p-3">
                            <div class="col-lg-4">
                                @php $image = str_replace("/public","",url('/')).'/storage/'.$rights_responsibilities->image_path.$rights_responsibilities->image_name; @endphp
                                <img src="{{ $image }}" alt="" class="w-100">
                            </div>
                            <div class="col-lg-8">
                                <div class="position-relative">
                                    <h2 class="blue_sub_title">{{$rights_responsibilities->title}}</h2>
                        ...
                        <div class="row ul_li_image">
                            <div class="respons_heading mb-4 col-lg-6">
                                <h6>Patient Rights</h6>
                                <svg class="line" width="90" height="9" viewBox="0 0 90 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2.02431 7.09212C30.0244 6.09216 52.5242 0.592169 87.8787 2.46593" stroke="#02BB9A" stroke-width="3" stroke-linecap="round"></path>
                                </svg>
                            ...
                            <div class="respons_heading mb-4 col-lg-6">
                                ...
                                {!! $rights_responsibilities->responsibilities !!}
                            </div>
                        </div>
                        {{-- <div class="row px-md-5 px-3 ul_li_image">
